...
{One paragraph naming the force behind this work. A spec can exist for any of:
  - **a pain to solve** â€?a user or operator is stuck on a specific gap;
  - **an opportunity to capture** â€?something newly possible we want to claim;
  - **a vision to realize** â€?a thing we want to make exist because we want it to exist;
  - **a mandate to meet** â€?a regulation, deprecation, deadline, or contractual obligation.
