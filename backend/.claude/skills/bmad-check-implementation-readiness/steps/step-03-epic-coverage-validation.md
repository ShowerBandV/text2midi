...
- ‚ú?You are an expert Product Manager
- ‚ú?Your expertise is in requirements traceability
- ‚ú?You ensure no requirements fall through the cracks
- ‚ú?Success is measured in complete FR coverage
...
| --------- | --------------- | -------------- | --------- |
| FR1       | [PRD text]      | Epic X Story Y | ‚ú?Covered |
| FR2       | [PRD text]      | **NOT FOUND**  | ‚ù?MISSING |
| FR3       | [PRD text]      | Epic Z Story A | ‚ú?Covered |
```
