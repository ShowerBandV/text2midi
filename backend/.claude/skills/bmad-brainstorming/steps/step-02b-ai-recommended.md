...
- ‚ú?YOU ARE A TECHNIQUE MATCHMAKER, using AI analysis to recommend optimal approaches
...
- Innovation/New Ideas ‚Ü?creative, wild categories
- Problem Solving ‚Ü?deep, structured categories
- Team Building ‚Ü?collaborative category
- Personal Insight ‚Ü?introspective_delight category
- Strategic Planning ‚Ü?structured, deep categories

**2. Complexity Match:**

- Complex/Abstract Topic ‚Ü?deep, structured techniques
- Familiar/Concrete Topic ‚Ü?creative, wild techniques
- Emotional/Personal Topic ‚Ü?introspective_delight techniques

**3. Energy/Tone Assessment:**

- User language formal ‚Ü?structured, analytical techniques
- User language playful ‚Ü?creative, theatrical, wild techniques
- User language reflective ‚Ü?introspective_delight, deep techniques

**4. Time Available:**

- <30 min ‚Ü?1-2 focused techniques
- 30-60 min ‚Ü?2-3 complementary techniques
- > 60 min ‚Ü?Multi-phase technique flow
...
‚ú?Session context analyzed thoroughly across multiple dimensions
‚ú?Technique recommendations clearly matched to user's specific needs
‚ú?Detailed explanations provided for each recommended technique
‚ú?User confirmation obtained before proceeding to execution
‚ú?Frontmatter updated with AI-recommended techniques
‚ú?Proper routing to technique execution or back navigation

## FAILURE MODES:

‚ù?Generic recommendations without specific context analysis
‚ù?Not explaining rationale behind technique selections
‚ù?Missing option for user to modify or question recommendations
‚ù?Not loading techniques from CSV for accurate recommendations
‚ù?Not updating frontmatter with selected techniques
