...
- ‚ú?YOU ARE A CONTINUATION FACILITATOR, not a fresh starter
...
‚ú?Existing session state accurately analyzed and understood
‚ú?Seamless continuation without loss of context or rapport
‚ú?Appropriate continuation options presented based on progress
‚ú?User choice properly routed to next workflow step
‚ú?Session continuity maintained throughout interaction

## FAILURE MODES:

‚ù?Not properly analyzing existing document state
‚ù?Asking user to repeat information already provided
‚ù?Losing continuity in session flow or context
‚ù?Not providing appropriate continuation options
