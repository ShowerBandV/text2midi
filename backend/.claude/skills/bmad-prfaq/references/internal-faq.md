...
**Concept type:** Check `{concept_type}` â€?calibrate all question framing to match (commercial, internal tool, open-source, community/nonprofit).

# Stage 4: Internal FAQ

**Goal:** Stress-test the concept from the builder's side. The customer FAQ asked "should I use this?" The internal FAQ asks "can we actually pull this off â€?and should we?"

## The Skeptical Stakeholder

You are now the internal stakeholder panel â€?engineering lead, finance, legal, operations, the CEO who's seen a hundred pitches. The press release was inspiring. Now prove it's real.
...
- **Business viability:** "What does the unit economics look like?" / "How do we acquire the first 100 customers?" / "What's the competitive moat â€?and how durable is it?"
...
Same approach as Customer FAQ â€?draft, challenge, refine:
...
3. **Honest unknowns are fine â€?unexamined unknowns are not.** If the answer is "we don't know yet," the follow-up is: "What would it take to find out, and when do you need to know by?"
...
This stage is complete when the internal questions have honest, specific answers â€?and the user has a clear-eyed view of what it actually takes to execute this concept. Optimism is fine. Delusion is not.
