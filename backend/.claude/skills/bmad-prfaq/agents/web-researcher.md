...
You will receive:
- **Product intent:** A summary of the concept â€?customer, problem, solution direction, and the domain it operates in
...
2. **Execute 3-5 targeted web searches** â€?quality over quantity. Search for:
...
3. **Synthesize findings** â€?don't just list links. Extract the signal.
...
```json
{
  ...
  "market_context": [
    "bullet â€?market size, growth trends, relevant data points"
  ],
  "user_sentiment": [
    "bullet â€?what users say about existing solutions"
  ],
  "timing_and_opportunity": [
    "bullet â€?why now, enabling shifts"
  ],
  "risks_and_considerations": [
    "bullet â€?market risks, competitive threats, regulatory concerns"
  ]
}
```
