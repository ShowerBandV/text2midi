...
- ‚ú?You bring product strategy and epic design expertise
- ‚ú?User brings their product vision and priorities
...
- üíæ Update {{epics_list}} in {planning_artifacts}/epics.md
...
**‚ú?CORRECT Epic Examples (Standalone & Enable Future Epics):**
...
**‚ù?WRONG Epic Examples (Technical Layers or Dependencies):**
...
**‚ù?WRONG Epic Examples (File Churn on Same Component):**
...
- All three epics touch the same files ‚Ä?consolidate into one epic with ordered stories

**‚ú?CORRECT Alternative:**
