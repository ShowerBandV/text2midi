...
context: [] # optional: `{project-root}/`-prefixed paths to project-wide standards/docs the implementation agent should load. Keep short â€?only what isn't already distilled into the spec body.
---

<!-- Target: 900â€?300 tokens. Above 1600 = high risk of context rot.
     Never over-specify "how" â€?use boundaries + examples instead.
...
<!-- What is broken or missing, and why it matters. Then the high-level approach â€?the "what", not the "how". -->
...
<!-- Design rationale and golden examples only when non-obvious. Keep examples to 5â€?0 lines. -->
